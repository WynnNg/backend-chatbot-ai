carScreenSamples = [
    ...
    "AppBox Matrix",
    "AppBox màn hình",
    "tính năng AppBox trong màn hình",
    "tính năng AppBox",
    "AppBox màn hình ô tô",
    "AppBox matrix là gì á em",
    "màn hình android"
]
...
camera360Samples = [
    "thông tin camera 360",
    "tính năng camera 360",
    "protech",
    "giá của sản phẩm Camera 360 PROTECH 5",
    "giá camera protech",
    "protech 5",
    "camera tích hợp màn hình Android PROTECH 5",
    "camera protech 5",
    "protech 6",
    "camera protech 6",
    "camera protech 7",
